...
george = User.create(username: "George", email: "george@email.com", password: "password1")
lift_a = Workout.create(duration_minutes: 90, user_id: 2, share_status: true)
george.workouts.create(duration_minutes: 45, share_status: true, created_at: 25.hours.ago)
george.workouts.create(duration_minutes: 30, share_status: true, created_at: 50.hours.ago)
george.workouts.create(duration_minutes: 15, share_status: true, created_at: 70.hours.ago)
lift_b = Workout.create(duration_minutes: 90, user_id: 2, share_status: false)
george.workouts.create(duration_minutes: 45, share_status: false, created_at: 25.hours.ago)
george.workouts.create(duration_minutes: 30, share_status: false, created_at: 50.hours.ago)
george.workouts.create(duration_minutes: 15, share_status: false, created_at: 70.hours.ago)



paul = User.create(username: "Paul", email: "paul@email.com", password: "password2")
run_a = Workout.create(duration_minutes: 90, user_id: 3, share_status: true)
paul.workouts.create(duration_minutes: 45, share_status: true, created_at: 25.hours.ago)
paul.workouts.create(duration_minutes: 30, share_status: true, created_at: 50.hours.ago)
paul.workouts.create(duration_minutes: 15, share_status: true, created_at: 70.hours.ago)
run_b = Workout.create(duration_minutes: 90, user_id: 3, share_status: false)
paul.workouts.create(duration_minutes: 45, share_status: false, created_at: 25.hours.ago)
paul.workouts.create(duration_minutes: 30, share_status: false, created_at: 50.hours.ago)
paul.workouts.create(duration_minutes: 15, share_status: false, created_at: 70.hours.ago)


mark = User.create(username: "Mark", email: "mark@email.com", password: "password3")
bench_a = Workout.create(duration_minutes: 90, user_id: 4, share_status: true)
mark.workouts.create(duration_minutes: 45, share_status: true, created_at: 25.hours.ago)
mark.workouts.create(duration_minutes: 30, share_status: true, created_at: 50.hours.ago)
mark.workouts.create(duration_minutes: 15, share_status: true, created_at: 75.hours.ago)
bench_b = Workout.create(duration_minutes: 90, user_id: 4, share_status: false)
mark.workouts.create(duration_minutes: 45, share_status: false, created_at: 25.hours.ago)
mark.workouts.create(duration_minutes: 30, share_status: false, created_at: 50.hours.ago)
mark.workouts.create(duration_minutes: 15, share_status: false, created_at: 75.hours.ago)
...
Exercise.create(name: "Leg-Lifts", description: "Lie on your back. Place your hands, palms down, on the floor beside you. Raise your legs off the ground (Exhale as you go). Keep your knees locked throughout the exercise. Hold for 30 seconds, or as long as you can (with some routines, there is only a short contraction/holding period). Return to starting position (Inhale as you go).")


lift_a.exercise_instances.create(exercise_id: 2, weight_lbs: 50, sets: 4, reps:12, exercise_rating: 5, notes: "Keep Tension! Squeeze at the Top.")
